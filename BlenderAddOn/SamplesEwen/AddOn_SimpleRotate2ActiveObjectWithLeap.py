    ...
    def modal(self, context, event):
        ...
        if event.type == 'TIMER':
            ...
            if(len(self.lastFrames)<20):
                ...
                #print(dir(hands[0]))
                #print(hands[0].direction.pitch)
                #print(hands[0].direction.yaw)
                print(hands[0].direction.roll)
                rotateX = hands[0].direction.pitch-self.lastPitch
                rotateY = hands[0].direction.roll-self.lastRoll
                
                if(rotateX>0):
                    context.object.rotation_euler[1]= context.object.rotation_euler[1] - rotateX *0.05
                #context.object.rotation_euler[2]= context.object.rotation_euler[2] - rotateY *0.05
                if(rotateY>0):
                    context.object.rotation_euler[2]= context.object.rotation_euler[2] - rotateY *0.05
                
                
                lastPitch = hands[0].direction.pitch
                lastRoll= hands[0].direction.roll
                '''
